...
public class SalaryDetailService {
    ...
    public List<SalaryDetailDTO> findAllFilterByComponentCondition(String salaryComponent, double amount, String condition, LocalDate start_date, LocalDate end_date) throws Exception {
